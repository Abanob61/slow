...
async def on_message(message):
    if message.content.startswith('!test'):
        ...
        await client.send_message(message.channel, "First: You need to open [https://www.haxball.com/headlesstoken](<https://www.haxball.com/headlesstoken>) and get the token code from there.")  
